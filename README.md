...
flux-cluster/
├── .github/workflows/
│   └── validate.yaml              # CI: kustomize build + helm lint on every PR
│
├── clusters/
│   └── kind/
│       ├── flux-system/
...
│           └── kustomization.yaml # Active: prometheus, grafana, istio, envoy-gateway, loki, promtail, demo, tempo, opentelemetry
│
└── scripts/
